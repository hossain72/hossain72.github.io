  ...
  const contactMethods = [
    {
      ...
      onClick: (e: React.MouseEvent) => handleCopy("hossainanowar72@gmail.com", "email", e),
      icon: (
      ...
      label: "Email",
      value: copiedEmail ? 'Copied!' : 'hossainanowar72@gmail.com',
      copyIcon: copiedEmail ? <Check size={14} style={{ color: 'var(--color-accent-secondary)' }} /> : <Copy size={14} opacity={0.5} />
    },
    {
      href: "tel:+8801752867007",
      onClick: (e: React.MouseEvent) => handleCopy("+8801752867007", "phone", e),
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      label: "Phone",
      value: copiedPhone ? 'Copied!' : '+880 1752 867007',
      copyIcon: copiedPhone ? <Check size={14} style={{ color: 'var(--color-accent-secondary)' }} /> : <Copy size={14} opacity={0.5} />
    },
    {
      ...
      label: "LinkedIn",
      value: "linkedin.com/in/hossain72"
    },
    {
              ...
              <div className="contact-methods">
                {contactMethods.map((method, index) => (
                  <motion.a
                    ...
                    rel={method.target ? "noreferrer" : undefined}
